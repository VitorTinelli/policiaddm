        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-2xl h-fit">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="font-medium text-gray-600 dark:text-gray-300">Alistado em:</span>
                ...
                {sortedHistory.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.status && (
                        <div className={`text-sm px-2 py-1 rounded mb-2 font-medium inline-block ${getStatusColor(item.status)}`}>
