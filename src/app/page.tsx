      ...
      <div className="min-h-[calc(100vh-160px)] bg-gray-50 dark:bg-neutral-900 p-8 sm:p-4 md:p-2 lg:p-8">
        <div className="max-w-6xl mx-auto flex flex-col gap-12 sm:gap-8 md:gap-8 lg:gap-12">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-md p-8 sm:p-6 md:p-4 lg:p-8 flex flex-col md:flex-col lg:flex-row items-center gap-8 sm:gap-4 md:gap-4 lg:gap-8 relative">
                  <div className="flex-shrink-0">
                    <HabboProfilePicture
                      username={profileData.militar.nick}
                      size="l"
                      direction="2"
                    />
                  </div>
                  <div className="flex-1 text-center md:text-center lg:text-left">
                    <h2 className="text-3xl sm:text-2xl md:text-xl lg:text-3xl font-bold mb-2 text-gray-900 dark:text-white">
                      {profileData.militar.nick}
                    </h2>
                    <div className="text-xl sm:text-lg md:text-base lg:text-xl font-bold text-yellow-600 dark:text-yellow-400 mb-1">
                      {profileData.militar.patente_nome || "Soldado"}
                    </div>
                ...
                {getRecentHistory.length > 0 && (
                  <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-md p-8 sm:p-6 md:p-4 lg:p-8">
                    <h3 className="text-2xl sm:text-xl md:text-lg lg:text-2xl font-bold mb-6 sm:mb-4 md:mb-4 lg:mb-6 text-gray-900 dark:text-white">
                      Atividade Recente
                    </h3>
                    <div className="flex flex-col gap-4 sm:gap-3 md:gap-3 lg:gap-4">
                      {getRecentHistory.map((item: HistoricoItem) => (
                        <div
                          key={item.id}
                          className={`flex items-center gap-4 sm:gap-3 md:gap-3 lg:gap-4 p-4 sm:p-3 md:p-3 lg:p-4 rounded-lg bg-gray-50 dark:bg-neutral-700 ${
                            item.tipo === "curso"
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="font-bold text-gray-900 dark:text-white text-base sm:text-sm md:text-sm lg:text-base">
                              {item.titulo}
                            </div>
          ...
          <section className="bg-white dark:bg-neutral-800 rounded-lg shadow-md p-8 sm:p-6 md:p-4 lg:p-8">
            <h2 className="text-3xl sm:text-2xl md:text-xl lg:text-3xl font-bold mb-8 sm:mb-6 md:mb-4 lg:mb-8 text-gray-900 dark:text-white text-center">
              Acesso Rápido
            </h2>
                  ...
                  <div className="flex flex-col gap-4 sm:gap-3 md:gap-3 lg:gap-4">
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-gray-600 dark:text-gray-300 text-sm sm:text-xs md:text-xs lg:text-sm">
                          Registrar cursos para militares
                        </div>
                      </div>
                    </Link>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-gray-600 dark:text-gray-300 text-sm sm:text-xs md:text-xs lg:text-sm">
                          Todos os scripts da Escola de Formação Básica
                        </div>
                      </div>
                    </Link>
                  </div>
